...
<header class="header1">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				<!-- Logo -->
				<a href="management.php" class="logo">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="m_status.php">TRACK REQUEST STATUS</a>
							</li>
							<li>
								<a href="management_reports.php">REPORTS</a>
							</li>
				...
				<div class="header-icons">
					<div class="dropdown">
				    <button class="btn  dropdown-toggle" id="menu1" type="button" data-toggle="dropdown"><?php echo "Hello, Shyam Palreddy";?><img src="images/icons/icon-header-01.png"  alt="ICON">
				    </button>
