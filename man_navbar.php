		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="man_status.php">TRACK REQUEST STATUS</a>
							</li>
							<li>
								<a href="manager_reports.php">REPORTS</a>
							</li>
							<li>
								<a href="viewta.php">VIEW TAs</a>
							</li>
				...
				<div class="header-icons">
					<div class="dropdown">
				    <button class="btn  dropdown-toggle" id="menu1" type="button" data-toggle="dropdown"><?php echo "Hello, Kishore Ithadi ";?><img src="images/icons/icon-header-01.png"  alt="ICON">
				    </button>
