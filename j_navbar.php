			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li>
								<a href="junior.php" >HOME</a>
							</li>
							<li>
								<a href="j_status.php">TRACK REQUEST STATUS</a>
							</li>
							<li>
								<a href="junior_reports.php">REPORTS</a>
							</li>
							...
							<li>
								<a href="viewprofiles.php">VIEW PROFILES</a>
							</li>
						</ul>
					</nav>
				</div>
				...
				<div class="header-icons">
					<div class="dropdown">
				    <button class="btn  dropdown-toggle" id="menu1" type="button" data-toggle="dropdown"><?php echo "Hello, Sreekar Sudireddy";?><img src="images/icons/icon-header-01.png"  alt="ICON">
				    </button>
