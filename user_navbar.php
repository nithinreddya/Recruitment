			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li>
								<a href="user.php" style="color:orange;">HOME</a>
							</li>
				...
				<div class="header-icons">
				    ...
				    <button class="btn  dropdown-toggle" id="menu1" type="button" data-toggle="dropdown"><?php echo "Hello, Shiva";?><img src="images/icons/icon-header-01.png"  alt="ICON">
				    </button>
				    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
				      <li role="presentation" style="padding:10px;"><a role="menuitem" tabindex="-1" href="userprofile.php">Profile</a></li>
